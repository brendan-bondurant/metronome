Installation
1. You need to have Node.js installed, this was made with v16.15.1
2. Clone the repository
3. Navigate to your repository
4. Run this to add the dependencies
   ```npm install```
6. to run the application use `npm start` or `node server.js`
...
Fortunately, I found a great [tutorial on YouTube](https://www.youtube.com/watch?v=D08gOHOjeEk&list=PLXAhCH9FJ8zU2lR4ZvJGianiyVJlqm0z0&index=1). After that, I was able to make some alterations to the code to make it do what I wanted.
...
<h4>Thanks</h4>
Many thanks to musicandcode (https://github.com/musicandcode/Metronome) for a great tutorial.
